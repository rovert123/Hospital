<?php
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST"){
      ...
      if(empty($username_err) && empty($password_err)){
          ...
          $sql = "SELECT  idRol, documento, correo, nombre, apellido, password FROM usuario WHERE correo = ?";
          
          if(isset($_SESSION['idRol'])){
            switch($_SESSION['idRol']){
          
              case 1;
              header('location: ./includes/homeadmin.php');
              break;
          
              case 2;
              header('location: ./includes/homemedico.php');
              break;
          
              case 3;
              header('location: ./includes/homeencargado.php');
              break;

              case 4;
              header('location: ./includes/homepacientes.php');
              break;
              ...
              almacenada con hash*/
                          if(password_verify($password, $hashed_password)){
                              ...
                              // Redirigir al usuario a la página de admin
                                ...
                                header('location: ./includes/homeadmin.php');
                                break;
                              // Redirigir al usuario a la página de Medico
                                case 2;
                                header('location: ./includes/homemedico.php');
                                break;
                              // Redirigir al usuario a la página de encargado
                                case 3;
                                header('location: ./includes/homeencargado.php');
                                break;
    ...
    <div class="container">
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          <img src="./img/fondo.png" class="image"/>
        </div>
      </div>
  </div>   
  </form>
